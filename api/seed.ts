...
await db.exec('DELETE FROM site_stats')
...
await db.run(`
  ...
  VALUES ($1, $2, $3)
`, ['reviews', '38+', 'Google Reviews'])
await db.run(`
  INSERT INTO site_stats (stat_key, stat_value, label)
  VALUES ($1, $2, $3)
`, ['registration_time', '5 min', 'Fast Registration'])
await db.run(`
  INSERT INTO site_stats (stat_key, stat_value, label)
  VALUES ($1, $2, $3)
`, ['years_experience', '10+', 'Years of Service'])
await db.run(`
  INSERT INTO site_stats (stat_key, stat_value, label)
  VALUES ($1, $2, $3)
`, ['students_served', '5000+', 'Students Served'])
await db.run(`
  INSERT INTO site_stats (stat_key, stat_value, label)
  VALUES ($1, $2, $3)
`, ['pass_rate', '95%', 'JAMB Pass Rate'])
